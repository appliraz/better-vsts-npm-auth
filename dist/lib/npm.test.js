...
describe("In the Npm module,", () => {
    ...
    describe("the Npmrc class", () => {
         ...
         */
        let foo;
        beforeEach(() => (foo = new npm_1.Npmrc("foo")));
        describe("has a constructor which", () => {
            test("constructs a filePath to a .npmrc file when given a directory", () => {
                ...
                let foo = new npm_1.Npmrc("/some/path");
        ...
        describe("has a method readSettingsFromFile which", () => {
            ...
            test("resolves settings as JSON from .npmrc file with entries", () => {
                ...
                return expect(foo.readSettingsFromFile()).resolves.toHaveProperty("settings", { this: "that", other: "thing" });
            });
            describe("resolves settings as empty JSON when .npmrc", () => {
                ...
                test("does not exist", () => {
                    ...
                    return expect(result)
                        .resolves.toBeInstanceOf(npm_1.Npmrc)
        ...
        describe("has a method getUserNpmrc which", () => {
            test("returns an Npmrc object using homedir when NPM_CONFIG_USERCONFIG is not set", () => {
                ...
                let result = npm_1.Npmrc.getUserNpmrc();
                expect(result).toBeInstanceOf(npm_1.Npmrc);
    ...
    describe(name, () => {
        describe("has a constructor which", () => {
            describe("constructs an object", () => {
                ...
                let o;
                beforeAll(() => {
                    o = new npm_1.Registry(fakeRegistry);
                });
        ...
        describe("has a method 'getAuthSettings' which", () => {
            ...
            let o;
            beforeEach(() => {
                o = new npm_1.Registry(useLegacyUrl ?
